...
void MuCapPACTScan::init(HistogramFactory &hf, const DetectorGeo& geom, const ConfigFile& conf) {
  ...
  qq_[0].push_back(MuCapPACTScanQuadrant(hf, "MuCapture/PACTScan", geom, conf, "11"));
  qq_[0].push_back(MuCapPACTScanQuadrant(hf, "MuCapture/PACTScan", geom, conf, "12"));
  qq_[1].push_back(MuCapPACTScanQuadrant(hf, "MuCapture/PACTScan", geom, conf, "21"));
  qq_[1].push_back(MuCapPACTScanQuadrant(hf, "MuCapture/PACTScan", geom, conf, "22"));
}

void MuCapPACTScan::fill(const EventClass& evt, const WireCluster& pc5cluster, const WireCluster& pc6cluster) {
