...
//minhist:        //----------------
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/vars", "RangeCosVsP");
//minhist:
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/ccut/cutMaxPlane", 55);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/ccut/cutMaxRout", 15.);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/ccut/useExtendedRange", true);
//minhist:
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/numGeneratorBins", 650);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/genpmin", 0.);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/genpmax", 650.);
//minhist:
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/xvarnbins", 250);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/xvarmin", 25.);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/xvarmax", 650.);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/yvarnbins", 6);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/yvarmin", 8.);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/contained/yvarmax", 32.);
//minhist:
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/uncontained/recopnbins", 250);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/uncontained/recopmin", 25.);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/uncontained/recopmax", 650.);
//minhist:
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/hitbased/cwiresnbins", 60);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/hitbased/cwiresmin", 0.5);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/hitbased/cwiresmax", 60.5);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/hitbased/cplanesnbins", 25);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/hitbased/cplanesmin", 0.5);
//minhist:        SetKey(Conf, "MuCapture/channels/legacy/hitbased/cplanesmax", 25.5);
