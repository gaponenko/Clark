...
void MuCapPACTCut::init(HistogramFactory &hf, const DetectorGeo& geom, const ConfigFile& conf) {
  ...
  qq_[0].push_back(MuCapPACTQuadrant(hf, geom, conf, "MuCapture/PACT/q11", "_11"));
  qq_[0].push_back(MuCapPACTQuadrant(hf, geom, conf, "MuCapture/PACT/q12", "_12"));
  qq_[1].push_back(MuCapPACTQuadrant(hf, geom, conf, "MuCapture/PACT/q21", "_21"));
